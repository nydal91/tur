...
TERMUX_PKG_SRCURL=https://github.com/nydal91/Box64droidconf/releases/download/test/winexinputtest2.tar.gz
TERMUX_PKG_SHA256=f724c0832e20e3160bb4951fbae8a75ff517b40ab464503e4f1a0a646242fa03
...
"
# TODO: `--enable-archs=arm` doesn't build with option `--with-mingw=clang`, butss
